...
def initialize_vocab(vocabulary_path):
  ...
  if gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(vocabulary_path, mode="r") as f:
      ...
      #print('rev_vocab',rev_vocab)
      #rev_vocab ['_PAD\n', '_UNK\n', 'to\n', 'from\n', 'the\n', 'boston\n', 'on\n', 'round\n', 'trip\n', 'atlanta\n', "what's\n", 'lowest\n', 'fare\n', 'dallas\n', 'find\n', 'me\n', 'earliest\n', 'flight\n', 'any\n', 'day\n', 'of\n', 'week\n', 'display\n', 'all\n', 'flights\n', 'baltimore\n', 'july\n', 'thirty\n', 'first\n', 'economy\n', 'fares\n', 'new\n', 'york\n', 'miami\n', 'i\n', 'need\n', 'fly\n', 'denver\n', 'san\n', 'francisco\n', 'and\n', 'back\n']
    rev_vocab = [line.strip() for line in rev_vocab]
    #print('rev_vocab=========',rev_vocab)
    #['_PAD', '_UNK', 'to', 'from', 'the', 'boston', 'on', 'round', 'trip', 'atlanta', "what's", 'lowest', 'fare', 'dallas', 'find', 'me', 'earliest', 'flight', 'any', 'day', 'of', 'week', 'display', 'all', 'flights', 'baltimore', 'july', 'thirty', 'first', 'economy', 'fares', 'new', 'york', 'miami', 'i', 'need', 'fly', 'denver', 'san', 'francisco', 'and', 'back']
